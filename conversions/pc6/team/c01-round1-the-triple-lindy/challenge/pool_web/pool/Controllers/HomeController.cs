...
public class HomeController : Controller
{
    ...
    public IActionResult ViewCameras()
    {
        ...
        string internalApiUrl = _config.GetValue<string>("InternalAPIUrl") ?? apiurl;
        ...
        try
        {
            using (HttpResponseMessage response = _sharedClient.GetAsync(internalApiUrl + "api/getcamerastatus?securityToken=" + model.SecurityToken).Result)
            {
            ...
            {
                model.ImagePath1 = apiurl + "StaticFiles/6e19cc19829a4ff89eb54bf5a979c5cd.jpg?securityToken=" + model.SecurityToken;
                model.ImagePath2 = apiurl + "StaticFiles/794ac710948f4b90b7b22743650dde11.jpg?securityToken=" + model.SecurityToken;
                model.ImagePath3 = apiurl + "StaticFiles/d42d6b758fce495a9ac9e32466704c2f.jpg?securityToken=" + model.SecurityToken;
                model.ImagePath4 = apiurl + "StaticFiles/4c4c2b739c4b4c9eb864540cf2423bda.jpg?securityToken=" + model.SecurityToken;
                model.ImagePath5 = apiurl + "StaticFiles/74e0cc74c8be4679a9c917edb9987d02.jpg?securityToken=" + model.SecurityToken;
            }
            else
            {
