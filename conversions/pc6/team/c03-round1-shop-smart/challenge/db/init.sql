-- Shop SMart - Database initialization
-- Imported from original challenge db.sql with minor cleanup
...
(112,'animal sing two','Price job give understand. During growth on medical.',45.11,'images/products/00339-1497179028.png',1),
...
-- -----------------------------------------------------------
-- Table: payments (empty but required by schema)
-- -----------------------------------------------------------
